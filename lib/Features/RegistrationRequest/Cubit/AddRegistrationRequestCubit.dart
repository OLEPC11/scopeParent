...
import '../Data/Model/RegistrationRequestModel.dart';
...
class AddRegistrationRequestCubit extends Cubit<AddRegistrationRequestState> {
  ...
  void addRegistrationRequestServices ({
    ...
    try{
      RegistrationRequestModel registrationRequestModel=await AddRegistrationRequestServices().
      ...
      emit(AddRegistrationRequestSuccess(registrationRequestModel: registrationRequestModel));
    }catch (e){
