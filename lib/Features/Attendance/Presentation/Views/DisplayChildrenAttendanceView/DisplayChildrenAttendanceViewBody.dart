...
import 'ChildrenAttendanceItemWidget.dart';

class  DisplayChildrenAttendanceViewBody extends StatelessWidget {
  @override
          ...
          return SizedBox(
            child:  ListView.builder(
              ...
              itemBuilder: (BuildContext context,index) {
                return ChildrenAttendanceItemWidget(childModel:state.childModelList[index],);
