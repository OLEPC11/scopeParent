...
import 'package:scope_parent/Features/Invoices/Presentation/Views/DisplayChildrenView/ChildrenItemWidget.dart';
import '../../../../../Core/Widgets/TextWidget.dart';
import '../../../../ChildDetails/Cubit/ShowAllChildCubit/ShowAllChildCubit.dart';
import 'ChildrenHomeworkItemWidget.dart';

class  DisplayChildHomeworkViewBody extends StatelessWidget {
  @override
          ...
          return     SizedBox(
            child:  ListView.builder(
              ...
              itemBuilder: (BuildContext context,index) {
                return ChildrenHomeworkItemWidget(childModel:state.childModelList[index],);
              },
            ),
          );
        }
